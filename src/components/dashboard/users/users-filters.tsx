...
import { useUsersSelection } from "./users-selection-context";
import { deleteUser, activeUser } from "@/app/dashboard/users/_actions/update-user";
...
export function UsersFilters({ filters = {}, sortDir = "desc" }: UsersFiltersProps): React.JSX.Element {
